...
export function TourEditor({ tour, onClose, onSaved }: { tour: any | null; onClose: () => void; onSaved: (tour: any) => void }) {
  ...
  const [form, setForm] = useState(() => ({
    ...
    isBookingEnabled: tour?.isBookingEnabled ?? true, badge: tour?.badge || '', sortOrder: tour?.sortOrder ?? 0,
  }));
  ...
  const payload = useMemo(() => ({
    ...
    startTime: form.startTime || null, endTime: form.endTime || null, videoUrl: form.videoUrl || null, badge: form.badge || null,
