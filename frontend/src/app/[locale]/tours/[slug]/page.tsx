...
import { getPublicTour, getPublicTours } from '@/lib/catalogApi';
...
export default async function TourPage({ params }: Props) {
  ...
  const related = (await getPublicTours(locale, { category: tour.category.slug })).filter((item) => item.id !== tour.id).slice(0, 4);
