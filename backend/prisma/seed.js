...
async function main() {
    ...
    const tours = [
        {
            ...
            category: client_1.TourCategory.BALLOON,
            basePrice: 250,
        ...
        },
        {
            ...
            category: client_1.TourCategory.DAILY_TOUR,
            basePrice: 75,
            duration: '8-10 hours',
            maxCapacity: 15,
            images: [
        ...
        },
        {
            ...
            category: client_1.TourCategory.ADVENTURE,
            basePrice: 60,
            duration: '2-3 hours',
            maxCapacity: 10,
            images: [
        ...
        },
        {
            ...
            category: client_1.TourCategory.TRANSFER,
            basePrice: 40,
            duration: '45-60 min',
            maxCapacity: 6,
            images: [
    ...
    for (const tourData of tours) {
        ...
        if (tour.category === client_1.TourCategory.BALLOON) {
